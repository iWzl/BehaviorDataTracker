...
public final class CollectionUtils {
     ...
     */
    public static <T> CompareResult<T> compare(Collection<T> newCollection,
                                               Collection<T> oldCollection, Comparator<T> comparator) {
    ...
    public static class CompareResult<T> {
         ...
         * 列表比较结果对象
         *
         * @param addValueIn 新增的对象列表
         * @param delValueIn delValue
         * @param unmodifiedValueIn unmodifiedValue
         */
        public CompareResult(List<T> addValueIn, List<T> delValueIn, List<T> unmodifiedValueIn) {
            this.addValue = addValueIn;
            this.delValue = delValueIn;
            this.unmodifiedValue = unmodifiedValueIn;
        }
