...
public final class PlaceholderResolver {
     ...
     * NUMBER_FLAG 标识
     */
    private static final Integer NUMBER_FLAG = -1;
     ...
     * 私有化的有参构造器
     *
     * @param placeholderPrefixIn 占位符前缀
     * @param placeholderSuffixIn 占位符后缀
     */
    private PlaceholderResolver(String placeholderPrefixIn, String placeholderSuffixIn) {
        this.placeholderPrefix = placeholderPrefixIn;
        this.placeholderSuffix = placeholderSuffixIn;
    }
    ...
    public String resolve(String content, String[] values) {
        ...
        if (start == NUMBER_FLAG) {
            return content;
        }
        //值索引
        int valueIndex = 0;
        StringBuilder result = new StringBuilder(content);
        while (start != NUMBER_FLAG) {
