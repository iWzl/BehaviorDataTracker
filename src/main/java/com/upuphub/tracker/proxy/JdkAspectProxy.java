...
public final class JdkAspectProxy implements InvocationHandler {
    ...
    /**
     * JdkAspectProxy的代理对象的无参构造器
     *
     * @param target 动态代理触发的原始对象
     * @param abstractInterceptor 针对原始对象增强实现方法
     */
    private JdkAspectProxy(Object target, AbstractInterceptor abstractInterceptor) {
        this.target = target;
    ...
    public static Object wrap(Object target, AbstractInterceptor abstractInterceptor) {
        JdkAspectProxy jdkAspectProxy = new JdkAspectProxy(target, abstractInterceptor);
